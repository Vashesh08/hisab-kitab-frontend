...
import { fetchVijayStockList, postVijayStock } from "../../api/vijayBook.js";

function VijayMeltingBookAdd({handleOk, setClosingBalance, setClosing995Balance, setClosing100Balance}) {
    ...
    form.resetFields();
        ...
        if ((parseFloat(totalWeight) <= parseFloat(balanceData[0]["meltingBookClosingBalance"])) && (parseFloat(totalWeight995) <= parseFloat(balanceData[0]["meltingBookClosing995Balance"])) && (parseFloat(totalWeight100) <= parseFloat(balanceData[0]["meltingBookClosing100Balance"]))){
          ...
          const backendData = {
            ...
            await postVijayStock(backendData, token);
...
export default VijayMeltingBookAdd;
