...
import { updateGovindCapMeltingBook } from "../../api/govindCapMeltingBook.js";
import Loading from "../Loading.js";
import { Button, Form, InputNumber } from "antd";
import { postLossAcct } from "../../api/LossAcct.js";


function GovindCapMeltingBookUpdate({handleOk, textData}) {
    ...
    const onFinish = async ({ user }) => {
        ...
        await updateGovindCapMeltingBook(backendData, token);
...
export default GovindCapMeltingBookUpdate;
