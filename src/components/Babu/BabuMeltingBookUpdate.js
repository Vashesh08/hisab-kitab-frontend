...
import { updateBabuMeltingBook } from "../../api/babuMeltingBook.js";
import Loading from "../Loading.js";
import { Button, Form, InputNumber } from "antd";
import { postLossAcct } from "../../api/LossAcct.js";


function BabuMeltingBookUpdate({handleOk, textData}) {
    ...
    const onFinish = async ({ user }) => {
        ...
        await updateBabuMeltingBook(backendData, token);
...
export default BabuMeltingBookUpdate;
