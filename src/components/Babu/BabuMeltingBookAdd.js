...
import { fetchBabuMeltingStockList, postBabuMeltingStock } from "../../api/babuMeltingBook.js";

function BabuMeltingBookAdd({handleOk, setClosingBalance, setClosing995Balance, setClosing100Balance}) {
    ...
    form.resetFields();
        ...
        if ((parseFloat(totalWeight) <= parseFloat(balanceData[0]["meltingBookClosingBalance"])) && (parseFloat(totalWeight995) <= parseFloat(balanceData[0]["meltingBookClosing995Balance"])) && (parseFloat(totalWeight100) <= parseFloat(balanceData[0]["meltingBookClosing100Balance"]))){
          ...
          const backendData = {
            ...
            await postBabuMeltingStock(backendData, token);
...
export default BabuMeltingBookAdd;
