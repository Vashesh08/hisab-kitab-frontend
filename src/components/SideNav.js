...
className="z-40 top-1 fixed text-white inline-flex items-center p-2 mt-2 ms-3 text-sm hover:text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
...
<aside id="sidebar-multi-level-sidebar" className="fixed left-0 z-30 w-64 h-screen transition-transform -translate-x-full" aria-label="Sidebar">
