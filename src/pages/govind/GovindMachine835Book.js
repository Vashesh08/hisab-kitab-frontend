...
const GovindMachine835Book = () => {
  ...
  async function updateRows (dataType){
    ...
    if (totalQty[0]["machine835Receive"].length === 0 || totalQty[0]["machine835Receive"][0]["machine835Receive"] === null){
    ...
    if (totalQty[0]["machine835Loss"].length === 0 || totalQty[0]["machine835Loss"][0]["machine835Loss"] === null){
  ...
  const columns = [
    ...
    },
    {
      ...
      ...getColumnSearchProps('machine835Date'),
      align: 'right',
    },
    {
      title: "Description",
      dataIndex: "machine835Description",
      render: text => (
        <div style={{ minWidth:'140px', maxWidth: '140px', overflow: 'auto'}}>
          {text}
        </div>
      ...
      width: '10%',
      ...getColumnSearchProps('machine835Description'),
    },
    {
      title: "Issue",
      dataIndex: "machine835Issue",
      ...
      {screenWidth > 953 ? (
          <div className="text-xl border-transparent flex justify-between items-center">
            ...
            <div style={{
              ...
              fontWeight: 'bolder',
              lineHeight: "2em",
              }} className="text-center text-[#00203FFF]" >Govind Machine 83.5 Book</div>
...
export default GovindMachine835Book;