...
const GovindDaiBhuka = () => {
  ...
  const handlePrintNow = useReactToPrint({
    ...
    documentTitle: 'Govind Dai Bhuka Book - ' + dayjs().format("DD-MM-YYYY"),
    // onBeforeGetContent: () => {
  ...
  return (
    <div>
      ...
      {!isPaginationEnabled && <div className="text-5xl text-center mb-8 print-only">Govind Dai Bhuka Book</div>}
      ...
      <Table
        ...
        footer={isPaginationEnabled ? false : () => (
          <div className="print-footer">
            Govind Dai Bhuka Book - {dayjs().format("DD-MMMM-YYYY")}
          </div>
        )}
        summary={() => {
          return (
