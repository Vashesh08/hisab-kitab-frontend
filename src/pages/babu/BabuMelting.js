...
import BabuMeltingBookAdd from "../../components/Babu/BabuMeltingBookAdd.js";
import '../../style/pages.css';
import Loading from "../../components/Loading.js";
import BabuMeltingBookUpdate from "../../components/Babu/BabuMeltingBookUpdate.js";
import { EditOutlined, DeleteOutlined, PlusCircleOutlined, PrinterOutlined, BarsOutlined, SearchOutlined } from "@ant-design/icons";
import { Tooltip } from 'antd';
import { deleteLossAcctList, fetchLossAcctList } from "../../api/LossAcct.js";
import { fetchBabuMeltingStockList, deleteBabuMeltingStockList } from "../../api/babuMeltingBook.js";
...
const BabuMelting = () => {
  ...
  const handlePrintNow = useReactToPrint({
    ...
    documentTitle: 'Babu Melting - ' + dayjs().format("DD-MM-YYYY"),
    // onBeforeGetContent: () => {
  ...
  const deleteModal = async () => {
    ...
    selectedRowKeys.map((item, index) => {
      ...
      const matchedData = lossAcctData.find(row => row.transactionId === item && row.type === "Babu Melting")
      if (matchedData){
    ...
    await deleteBabuMeltingStockList(meltingBookId, token);
  ...
  return (
    <div>
        {screenWidth > 953 ? (
          ...
          <>
            <div style={{
              ...
              fontWeight: 'bolder',
              lineHeight: "2em",
              }} className="text-center text-[#00203FFF]" >Babu Melting Book</div>
      ...
      <Modal
        title="Add Item To Babu Melting Book"
        open={isModalOpen}
      ...
      {!isPaginationEnabled && <div className="text-5xl text-center mb-8 print-only">Babu Melting Book</div>}
      ...
      <Table
        ...
        footer={isPaginationEnabled ? false : () => (
          <div className="print-footer">
            Babu Melting - {dayjs().format("DD-MMMM-YYYY")}
          </div>
        )}
        summary={() => {
          return (
